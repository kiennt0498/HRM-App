...
public class XImage {//tạo 1 biến url có kiểu là url
    public static Image getAppIcon(){
     ...
     public static void save(File src){//save tạo 1 biến file dst
        File dst = new File("src\\main\\resources\\com\\app\\hrm\\logo",src.getName());//lấy đường dẫn vào file logo lấy tên file
     ...
     public static ImageIcon read(String fileName){//đọc file icon
         File path = new File("src\\main\\resources\\com\\app\\hrm\\logo",fileName);// biến path kiểu dữ liệu là file có đường dãn là logo
