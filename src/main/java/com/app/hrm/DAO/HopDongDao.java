...
public class HopDongDao extends HRMDAO<HopDong, Integer>{
    ...
    final String UPDATE_SQL = "UPDATE HopDong SET MaNV = ?,NgayBatDau = ?,NgayKetThuc= ?,ngayKy=?,NoiDung=?,LanKy=?,idcv=?,luongcb=? WHERE SoHD = ?";
    final String DELETE_SQL = "DELETE FROM HopDong WHERE MaHD = ?" ;
