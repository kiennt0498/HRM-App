...
public class LuongDao extends HRMDAO<Luong, Integer>{
    ...
    public void insert(Luong e) {
      JdbcHelp.update(INSERT_SQL, e.getManv(),e.getGio(),e.getBacLuong(),e.getLuongCB(),e.getPhuCap(),e.getUngLuong(),e.getKTKL(),e.getTangCa(),e.getLuong(),e.getMaKC(),e.getBaohiem(),e.getThue());
    }
