...
public class HoSo extends javax.swing.JPanel {
    ...
    void filltable() {
        ...
        try {
            ...
            for (NhanVien nv : list) {
                ...
                Object[] row = {nv.getMaNV(), nv.getHoTen(), nv.isGioiTinh() ? "Nam" : "Nữ", nv.getNgaySinh(), nv.getDienThoai(), nv.getCCCD(), nv.getDiaChi(), trinhDo, chucVu, phongban, nv.getHinh()};
                tblMode.addRow(row);
            }
    ...
    void chonAnh() {
        ...
        if (fileChooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            ...
            XImage.save(file);
            try {
                File path = new File("src\\main\\resources\\com\\app\\hrm\\logo", file.getName());
                BufferedImage image = ImageIO.read(path);
                int x = lblHinh.getSize().width;
                int y = lblHinh.getSize().height;
                int ix = image.getWidth();
    ...
    private void initComponents() {
        ...
        pnlNhanVienLayout.setHorizontalGroup(
            ...
            .addComponent(Scroll, javax.swing.GroupLayout.DEFAULT_SIZE, 984, Short.MAX_VALUE)
        );
