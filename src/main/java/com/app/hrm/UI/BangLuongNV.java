...
public class BangLuongNV extends javax.swing.JPanel {
    ...
    void filltable() {
        ...
        try {
            ...
            for (Luong l : list) {
                Date ngaytinh = kcdao.selectById(l.getMaKC()).getNgayTinh();
                String ngay = XDate.toString(ngaytinh);
                Object[] row = {ngay, l.getGio(), l.getLuongCB(),l.getBacLuong(), l.getTangCa(), l.getPhuCap(), l.getKTKL(),l.getBaohiem(), l.getUngLuong(),l.getThue(), l.getLuong()};
                model.addRow(row);
            }
        } catch (Exception e) {
            e.printStackTrace();
